...
$checksum       = 'd5c3483ecd12b520a702e19d2cccc4cb'
$url64          = 'https://github.com/docker/machine/releases/download/v0.8.0/docker-machine-Windows-x86_64.exe'
$checksum64     = '732afc07186cf2735bf4b8fb9312279a'
$checksumType   = 'md5'
$checksumType64 = 'md5'

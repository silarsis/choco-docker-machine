...
version=$1
url="https://github.com/docker/machine/releases/download/${version}/docker-machine-Windows-i386.exe"
url64="https://github.com/docker/machine/releases/download/${version}/docker-machine-Windows-x86_64.exe"
